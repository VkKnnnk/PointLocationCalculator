...
Когда один луч указывает находится ли точка внутри многоугольника, а остальные лучи показывают обратное, используется принцип большинства для принятия решения.
